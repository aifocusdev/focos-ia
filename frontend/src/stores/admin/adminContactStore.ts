...
import { contactService } from '../../services/admin-contact/contact.service'
import { tagService } from '../../services/admin-tag/tag.service'
import type {
  Contact,
  ContactFilters,
  Tag,
...
export const useContactStore = create<ContactState>((set, get) => ({
  ...
  fetchTags: async () => {
    ...
    try {
      ...
      set({ tags, tagsLoading: false, tagsLoaded: true })
    } catch (error) {
      set({
        tagsLoading: false,
